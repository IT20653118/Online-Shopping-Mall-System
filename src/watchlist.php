		...
		<table class="table1" border="1" align="center" width="50%" > 
			<tr> 
				<td>
					<br>
					<center>
					<img src="images/watchlist.png" alt="empty-cart" width="100px" height="100px">
					</center>
					<h5 style="color:blue;text-align:center;font-size:75px;">No Items Available<br> In The Watchlist</h5> 
					<center>
